...
% TODO: Describe MakeFile and TBA function to determine which worker to choose.
% Mention problems that happened and why we needed to add semaphore for file to
% get rid of them.
